...
var words = [ { "word": "PRESSURE-SUITS",
            ...
            { "word": "SPACECRAFT", "direction": "E", "start": 2},
            { "word": "ASTRONAUTS", "direction": "S", "start": 19 },
            { "word": "VACUUM", "direction": "NW", "start": 168 },
            { "word": "SENSOR", "direction": "E", "start": 33 },
			];
...
function sound() {
	var sound = new Audio('/sound-design/background/game2.mp3');
	sound.volume = 0.3;
	sound.loop = true;
	sound.play();
}
...
var meaning = {
  "PRESSURE-SUITS":
    "ชุดป้องกันแรงดันอากาศสำหรับการบินในระดับความสูงที่ความดันอากาศต่ำ",
  SPACESUITS: "ชุดนักบินอวกาศ",
  SPACECRAFT: "ยานอวกาศ",
  ASTRONAUTS: "นักบินอวกาศ",
  VACUUM: "สุญญากาศ",
  SENSOR:
    "ป็นวัตถุชนิดหนึ่งที่มีหน้าที่ตรวจจับเหตุการณ์หรือการเปลี่ยนแปลงของสภาพแวดล้อมของตัวมันเอง",
};
